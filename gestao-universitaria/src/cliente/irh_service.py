...
class IRHService(ABC):
    ...
    Para que o pagamento seja realizado todo funcionario deve ter seu cpf e nome cadastrado na folha de pagamento.
    Professores são classificados em classes(A, B, C, D, E). A classe a qual o professor pertence influencia diretamente no seu salario.
    ...
    Nem todo mundo tem direito a diarias. Veja as regras ao longo do código.
    """
